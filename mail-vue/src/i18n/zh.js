const zh = {
    ...
    sendEmail: '邮件发送',
    emailProvider: '邮件发送方式',
    emailProviderDesc: 'CF优先：先用Cloudflare Email Service发送，失败后回退Resend。仅Resend：只用Resend发送。仅CF：只用Cloudflare发送（无回退）。',
    cfFirst: 'CF优先 (Resend备选)',
    resendOnly: '仅 Resend',
    cfOnly: '仅 Cloudflare',
    externalApiKey: '外部 API 密钥',
    externalApiKeyDesc: '其他应用调用 POST /api/external/send 发送邮件时使用的密钥，请妥善保管。',
    externalApiKeyPlaceholder: '点击"生成"创建密钥',
    generate: '生成',
